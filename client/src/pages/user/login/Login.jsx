...
export default function Login() {
  ...
  const handleInputChange = (e) => {
    ...
    // Khi onChange thì gọi đến hàm validate luôn
        ...
        .then((response) => {
          if (response.status === 200) {
            ...
            if (response.data.user.role === 0) {
              console.log("Chuyển sang trang admin");
            } else {
              console.log("Chuyển sang trang người dùng ");
            }
          }
        })
        .catch((error) => {
        ...
        <form className="form-login" onSubmit={handleSubmit}>
          ...
          <div className="form-group mt-3">
            ...
            <input
              ...
              name="email"
              onBlur={handleInputChange} // hàm ấn vào ô input ấn ra bên ngoài là báo lỗi luôn
            />
            {emailError && (
          ...
          <div>
            <button style={{ width: "100%" }} className="btn btn-info mt-3">
              Đăng nhập
            </button>
            <p>
